...
namespace Data
{
    public class UserData
    {
        ...
        public static PoliceEntity Login(UserCredentials credentials)
        {
            try
            {
                ...
                PoliceEntity police = client.Post<PoliceEntity>(request).Data;
        ...
        public static List<UserEntity> GetByUserType(string type)
        {
            try
            {
                RestClient client = new RestClient(URL);
                RestRequest request = new RestRequest("/type/{type}", Method.GET);
                request.AddUrlSegment("type", type);
                List<UserEntity> users = client.Get<List<UserEntity>>(request).Data;
                return users;
            }
            catch (Exception e)
            {
